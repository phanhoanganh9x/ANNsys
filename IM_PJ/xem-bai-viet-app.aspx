...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="/App_Themes/Ann/js/sync-post.js?v=01122021"></script>
    <script src="/App_Themes/Ann/js/copy-post-app-info.js?v=01122021"></script>
    <script src="/App_Themes/Ann/js/download-post-app-image.js?v=01122021"></script>
