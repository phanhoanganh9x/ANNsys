...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="/App_Themes/Ann/js/copy-post-to-app.js?v=28112021"></script>
    <script src="/App_Themes/Ann/js/copy-post-info.js?v=28112021"></script>
    <script src="/App_Themes/Ann/js/download-post-image.js?v=28112021"></script>
</asp:Content>
