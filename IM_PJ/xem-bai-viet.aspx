...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="/App_Themes/Ann/js/copy-post-to-app.js?v=12092020"></script>
    <script src="/App_Themes/Ann/js/copy-post-info.js?v=12092020"></script>
    <script src="/App_Themes/Ann/js/download-post-image.js?v=12092020"></script>
</asp:Content>
