<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dang-ky-jt.aspx.cs" Inherits="IM_PJ.dang_ky_jt" EnableSessionState="ReadOnly" %>
...
<body class="bg07">
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            <main>
                <div class="container container-bg">
                    <div class="row top-bar">
                        <img width="250" src="/uploads/images/jt-logo.png">
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-6">
                            ...
                            <div class="form-group row">
                                <label for="cod" class="col-4 col-xl-4 col-form-label">Tiền thu hộ</label>
                                <div class="input-group col-8 col-xl-8">
                                    <input type="text" id="cod" class="form-control text-right" value="0" disabled="disabled" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            <script type="text/javascript" src="App_Themes/Ann/js/pages/dang-ky-jt/dang-ky-jt.js?v=202109300102"></script>
        </div>
    </form>
</body>
</html>
